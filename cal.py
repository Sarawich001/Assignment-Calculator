            ...
            controls=[
                ...
                ft.Row(
                    controls=[
                        ...
                        DigitButton(
                            text="0", expand=1, button_clicked=self.button_clicked
                        ),
                        ActionButton(text="=", button_clicked=self.button_clicked),
                    ]
                ),
    ...
    def button_clicked(self, e):
        ...
        if self.result.value == "Error" or data == "AC":
            ...
            try:
                ...
                self.result.value = self.format_number(math.sin(angle_rad))
                self.reset()
            except:
            ...
            try:
                ...
                angle_rad = math.radians(float(self.result.value))
                self.result.value = self.format_number(math.cos(angle_rad))
                self.reset()
            except:
                self.result.value = "Error"
                self.reset()
